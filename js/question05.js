document.addEventListener('DOMContentLoaded', () => {
    ...
    const imageMap = {
        'head': '../assets/images/question05/head05.png',
        'neck': '../assets/images/question05/neck05.png',
        'shoulder': '../assets/images/question05/shoulder05.png'
    };
    ...
    const correctAnswer = 'shoulder';  

    function showResult() {
        if (selectedPart === correctAnswer) {
            modalMessage.textContent = 'Resposta correta! Você completou o nosso Quiz! Parabéns pelo empenho.';
